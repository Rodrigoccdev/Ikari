...
if (isset($_FILES['archivo'])) {
    ...
    /*$sql2 = "SELECT id FROM productos WHERE nombre = '$nombre_inf'";
    ...
    if ($extension == "jpg" || $extension == "jpeg" || $extension = "png") {
        ...
        descuento = '$descuento', id_categoria = '$categoria', activo = '$activo', imagen = '$nombre_archivo' WHERE id LIKE $id";
        ...
        if ($resultado) {
            ...
            if(is_dir($my_dir)){
                ...
                echo "<script language='JavaScript'>
                alert('Error al agregar el articulo (directorio existente): ');
                location.assign('../update/');
                </script>";
            }
        } else {
